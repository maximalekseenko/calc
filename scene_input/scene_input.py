...
class Scene_Input(Scene):
    ...
    def __init__(self, act, base: pygame.Surface | pygame.Rect | None = None) -> None:
        ...
        self.buttons:list[list[Element_Button]] = [
            [Element_Button(self, "OFF", '\x1b'), Element_Button(self, "AC", '\x7f'), Element_Button(self, "BSP", '\x08'), Element_Button(self, "ANS", 'a')],
            ...
            [Element_Button(self, "=", '='), Element_Button(self, "0", '0'), Element_Button(self, "%", '%'), Element_Button(self, "/", '/')],
            ]
